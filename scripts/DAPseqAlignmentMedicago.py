...
ids_file = '../data/commonData/ids_data_medicago.csv'
working_folder = '../data/data_medicago/'
raw_folder = '../raw_data_medicago'
working_folder_name = 'data_medicago'
                    ...
                    if qualityCheckTrimGalore(targetFolder):
                        ...
                        if id.tf == 'Input':
                            ...
                            inputControlpath = os.path.join(
                                '/home/joaquin/projects/methylation/data', working_folder_name, 'Input/Medicago'
                            )
