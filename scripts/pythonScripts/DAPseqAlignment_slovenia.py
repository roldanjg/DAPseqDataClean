...
from utilpipeline import (checkFastaQLenght, checkMD5isCorrect,
                          ...
                          renameGemFolders, sortBamFiles,performGEMnoinput)
from constants import genomeIndex, gemIndex, genomeSizes


Species = 'Solanum tuberosum'
ids_file = '/home/joaquin/projects/methylation/data/commonData/ids_data_slovenia.csv'
working_folder = '/home/joaquin/projects/methylation/data/data_slovenia'
raw_folder = '/home/joaquin/projects/methylation/data/AllRawData/raw_data_slovenia'
working_folder_name = 'data_slovenia'
        ...
        if len(file_names) >= 2:
            ...
            if checkMD5isCorrect(originalfolder):
                ...
                if checkFastaQLenght(originalfolder):
                    ...
                    performGEMnoinput(targetFolder, working_folder_name)
