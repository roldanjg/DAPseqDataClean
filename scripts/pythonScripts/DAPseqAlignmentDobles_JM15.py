...
raw_folder = '/home/joaquin/projects/methylation/data/AllRawData/raw_data_dobles_JM15'
working_folder_name = 'data_dobles_JM15'
...
with cd(working_folder):
    for index, id in idsDf.iterrows():
        gzs = []
        targetFolder = os.path.join(id.replicate, id.condition, id.experimentid, str(id.inputid))
            ...
            if checkMD5isCorrect(originalfolder):
                ...
                if checkFastaQLenght(originalfolder):
                    ...
                    if qualityCheckTrimGalore(targetFolder):
                        samfileexperiment = '{}{}{}{}.sam'.format(
                            id.replicate, id.condition, id.experimentid, str(id.inputid)
                            )
                    ...
                    if id.replicate == 'Input':
                        ...
                        inputControlpath = os.path.join(
                            '/home/joaquin/projects/methylation/data', 
                            working_folder_name, 
                            'Input/Input/Input',
                            str(id.inputid)
                        )
