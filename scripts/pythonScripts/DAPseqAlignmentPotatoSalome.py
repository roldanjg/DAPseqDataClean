...
working_folder = '/home/joaquin/projects/methylation/data/data_potato_Salome/'
raw_folder = '/home/joaquin/projects/methylation/data/AllRawData/raw_data_potato_Salome'
working_folder_name = 'data_potato_Salome'
            ...
            if checkMD5isCorrect(originalfolder):
                ...
                if checkFastaQLenght(originalfolder):
                    ...
                    if qualityCheckTrimGalore(targetFolder):
                        samfileexperiment = '{}.sam'.format(id.tf)
