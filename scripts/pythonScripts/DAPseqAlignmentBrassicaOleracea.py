...
ids_file = '../data/commonData/ids_data_brassica_oleracea.csv'
working_folder = '../data/data_brassica_oleracea/'
raw_folder = '../raw_data_brassica_oleracea'
working_folder_name = 'data_brassica_oleracea'
                    ...
                    if qualityCheckTrimGalore(targetFolder):
                        ...
                        if id.tf == 'Input':
                            ...
                            inputControlpath = os.path.join(
                                '/home/joaquin/projects/methylation/data', working_folder_name, 'Input/Brassica'
                            )
