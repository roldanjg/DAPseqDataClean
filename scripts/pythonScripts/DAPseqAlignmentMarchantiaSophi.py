...
raw_folder = '../raw_data_sophie'
working_folder_name = 'data_sophie' #TODO LA HE CAGADO PONIENDO AL PRINCIPIO AQUI LA REPLICA 2, ME HE CARGADDO LOS INPUT
            ...
            if checkMD5isCorrect(originalfolder):
                ...
                if checkFastaQLenght(originalfolder):
                    ...
                    if qualityCheckTrimGalore(targetFolder):
                        samfileexperiment = '{}{}{}.sam'.format(id.tf, str(id.type), str(id.time))
                    ...
                    if id.tf == 'Input':
                        ...
                        inputControlpath = os.path.join(
                            '/home/joaquin/projects/methylation/data', working_folder_name, 'Input/Input/Input'
                        )
