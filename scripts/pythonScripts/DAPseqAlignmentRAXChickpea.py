...
ids_file = '../data/commonData/ids_data_RaxChickpea.csv'
working_folder = '../data/data_RaxChickpea/'
raw_folder = '../raw_data_RaxChickpea'
working_folder_name = 'data_RaxChickpea'
